...
async def main():
    ...
    # fake audio buffer that makes 80KB like the doctor.websocket logic
    ...
    for model in ["google/gemini-3-flash-preview", "google/gemini-2.5-flash", "google/gemini-1.5-flash"]:
